...
`,qi={root:({instance:n})=>["p-floatlabel",{"p-floatlabel-over":n.variant==="over","p-floatlabel-on":n.variant==="on","p-floatlabel-in":n.variant==="in"}]},Nn=(()=>{class n extends X{name="floatlabel";style=Li;classes=qi;static \u0275fac=(()=>{let e;return function(o){return(e||(e=C(n)))(o||n)}})();static \u0275prov=V({token:n,factory:n.\u0275fac})}return n})();var kn=new M("FLOATLABEL_INSTANCE"),Je=(()=>{class n extends J{componentName="FloatLabel";_componentStyle=u(Nn);$pcFloatLabel=u(kn,{optional:!0,skipSelf:!0})??void 0;bindDirectiveInstance=u(w,{self:!0});onAfterViewChecked(){this.bindDirectiveInstance.setAttrs(this.ptms(["host","root"]))}variant="over";static \u0275fac=(()=>{let e;return function(o){return(e||(e=C(n)))(o||n)}})();static \u0275cmp=W({type:n,selectors:[["p-floatlabel"],["p-floatLabel"],["p-float-label"]],hostVars:2,hostBindings:function(i,o){i&2&&x(o.cx("root"))},inputs:{variant:"variant"},features:[A([Nn,{provide:kn,useExisting:n},{provide:Z,useExisting:n}]),z([w]),g],ngContentSelectors:$i,decls:1,vars:0,template:function(i,o){i&1&&(he(),me(0))},dependencies:[Q,B,At],encapsulation:2,changeDetection:0})}return n})(),On=(()=>{class n{static \u0275fac=function(i){return new(i||n)};static \u0275mod=S({type:n});static \u0275inj=F({imports:[Je,B,B]})}return n})();var Pn=`
    .p-textarea {
        font-family: inherit;
        font-feature-settings: inherit;
        font-size: 1rem;
